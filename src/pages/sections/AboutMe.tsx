...
const AboutMe = () => {
    ...
    return (
        <div className="relative flex min-h-[100svh] snap-start flex-col items-center justify-center gap-12 bg-blue-300 bg-gradient-to-b from-amber-300 from-10% transition-colors duration-500 dark:bg-blue-800 dark:from-amber-800 md:min-h-screen">
