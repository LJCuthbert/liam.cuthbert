...
const AboutMe = () => {
    ...
    return (
        <div className="relative flex min-h-svh snap-start flex-col justify-end gap-12 bg-blue-300 bg-gradient-to-b from-amber-300 from-10% transition-colors duration-500 md:container dark:bg-blue-800 dark:from-amber-800 md:min-h-screen md:items-center md:justify-center">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                ...
                <Card title="Personal Information">
                    <div className="inline-block">
                        ...
                        ></CreativeWords>
                        based in Christchurch. I love coding, solving problems,
