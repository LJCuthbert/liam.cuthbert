        ...
        <div className="min-h-screen relative flex e flex-col items-center justify-evenly snap-start">
            <main className="p-4">
                <div className="details flex flex-col gap-5 text-center">
                    ...
                    <span className="">
                        <span
                            className="text-center md:text-left uppercase text-5xl flex flex-col md:flex-row gap-0 md:gap-3 text-amber-300 dark:text-amber-600">Creative <CreativeWords
