...
const Projects = () => {
    ...
    return (
        <div className="min-h-screen snap-start flex flex-col bg-amber-300 dark:bg-amber-800 transition-colors duration-500 justify-center items-center gap-12">
            <div className="container">
                <div ref={ref} className="text-center">
                    {inView && <TypewriterEffect text="Projects" />}
                </div>
                <div className="flex justify-center flex-wrap gap-4">
                    <ProjectCard projectName="Embedded System: Battleships" imageSrc={ConQuestDark} />
